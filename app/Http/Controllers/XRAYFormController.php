...
class XRAYFormController extends Controller
{
    ...
    {
        Log::info('Received XRAY data:', $request->all());
        ...
        try {
            $xraysave->save();
            return redirect()->route('officer.dashboard')->with('success', 'X-RAY data berhasil disimpan dan menunggu persetujuan supervisor.');
        } catch (\Exception $e) {
