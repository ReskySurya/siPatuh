    ...
    <div class="bg-white shadow-md rounded-lg">
                        ...
                        <div id="filterDropdown"
                            ...
                            <div class="p-3 sm:p-4">
                                ...
                                <form id="dateFilterForm" class="space-y-3 sm:space-y-4"
                                    action="{{ route('filter.hbscp.forms') }}" method="POST">
                                    @csrf
                                    <div>
        ...
        <div class="p-6">
            ...
            <div id="pending-content" class="tab-content px-4 sm:px-6 lg:px-8">
                <h2 class="text-lg sm:text-xl font-bold text-black">Formulir HHMD Pos HBSCP - Belum Diperiksa</h2>
                <h4 class="text-xs sm:text-sm font-light text-black mb-4">Daftar formulir HHMD Pos HBSCP yang belum
            ...
            <div id="all-content" class="tab-content hidden px-4 sm:px-6 lg:px-8">
                <h2 class=" text-lg sm:text-xl font-bold text-black">Semua Formulir HHMD Pos HBSCP</h2>
                <h4 class="text-xs sm:text-sm font-light text-black mb-4">Daftar lengkap semua formulir HHMD Pos HBSCP
                </h4>
                ...
                @else
                <div class="text-center py-4 sm:py-8">
                    <p class="text-xs sm:text-sm text-gray-500">Tidak ada formulir HHMD Pos HBSCP saat ini.</p>
                </div>
                @endif
            </div>
