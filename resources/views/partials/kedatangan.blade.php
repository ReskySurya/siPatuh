    ...
    <div class="bg-white shadow-md rounded-lg">
        ...
        <div class="border-b border-gray-200 p-2 sm:p-4 md:p-6">
            <div class="flex flex-col sm:flex-row justify-between items-center mb-3 sm:mb-4 md:mb-6 space-y-2 sm:space-y-0">
                <h1 class="text-base sm:text-xl md:text-2xl font-bold text-gray-800 w-full sm:w-auto text-center sm:text-left">
                    {{ __('Formulir HHMD POS Kedatangan') }}
                </h1>
            </div>
        ...
        <div class="p-6">
            ...
            <div id="pending-content" class="tab-content hidden px-2 sm:px-6 lg:px-8">
                ...
                <h4 class="text-[10px] sm:text-sm font-light text-black mb-2 sm:mb-4">Daftar formulir HHMD Pos Kedatangan yang belum
                ...
                <div class="text-center py-4 sm:py-8">
                    <p class="text-xs sm:text-sm text-gray-500">Tidak ada formulir HHMD Pos Kedatangan yang belum diperiksa
                        saat ini.</p>
                </div>
                @endif
            </div>
            ...
            <div id="all-content" class="tab-content hidden px-2 sm:px-6 lg:px-8">
                <h2 class="text-base sm:text-xl font-bold text-black">Semua Formulir HHMD Pos Kedatangan</h2>
                <h4 class="text-[10px] sm:text-sm font-light text-black mb-2 sm:mb-4">Daftar lengkap semua formulir HHMD Pos Kedatangan</h4>
                ...
                <div class="text-center py-2 sm:py-4">
                    <p class="text-[10px] sm:text-sm text-gray-500">
                        Tidak ada formulir HHMD Pos Kedatangan saat ini.
                    </p>
                </div>
                @endif
            </div>
