    ...
    <div class="bg-white shadow-md rounded-lg">
        ...
        <div class="p-6">
            ...
            <div id="pending-content" class="tab-content hidden px-2 sm:px-6 lg:px-8">
                ...
                <h4 class="text-[10px] sm:text-sm font-light text-black mb-2 sm:mb-4">Daftar formulir HHMD Pos Barat yang belum
            ...
            <div id="all-content" class="tab-content hidden px-2 sm:px-6 lg:px-8">
                <h2 class="text-base sm:text-xl font-bold text-black">Semua Formulir HHMD Pos Barat</h2>
                <h4 class="text-[10px] sm:text-sm font-light text-black mb-2 sm:mb-4">Daftar lengkap semua formulir HHMD Pos Barat</h4>
                ...
                <div class="text-center py-2 sm:py-4">
                    <p class="text-[10px] sm:text-sm text-gray-500">
                        Tidak ada formulir HHMD Pos Barat saat ini.
                    </p>
                </div>
                @endif
            </div>
