...
" class="relative h-screen">
    ...
    <!-- Sidebar -->
    <nav id="sidebar"
        class="fixed top-0 left-0 h-full bg-[#4A97CD] text-white transition-all duration-300 ease-in-out z-50" :class="{
        ...
        <div class="flex-grow overflow-y-auto no-scrollbar">
            <div class="p-4 space-y-4">
                ...
                <ul class="space-y-2">
                    ...
                    @if(Auth::check() && !Auth::guard('officer')->check() && Auth::user()->role === 'superadmin')
                    <li>
                        <a href="{{route('exportpdf.index')}}" class="flex items-center py-2 px-4 rounded hover:bg-[#3A87BD]">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            <span x-show="sidebarOpen" class="ml-3">Export PDF</span>
                        </a>
                    </li>
                    @endif
                </ul>
